            ...
            if i % 100 == 0:
                with torch.no_grad():
                    ...
                    try:
                        utils.save_image(
                            sample,
                            f"/content/drive/My Drive/Colab Notebooks/I2I_StyleGAN2-2/{str(i).zfill(6)}.png", # sample
            ...
            if i % 1000 == 0:
                try:
                    torch.save(
                        ...
                        f"/content/drive/My Drive/Colab Notebooks/I2I_StyleGAN2-2/{str(i).zfill(6)}.pt", # checkpoint/xxx
                      )
                except Exception as e:
...
if __name__ == "__main__":
    ...
    if args.ckpt is not None:
        ...
        g_optim.load_state_dict(ckpt["g_optim"],strict=True)
        d_optim.load_state_dict(ckpt["d_optim"],strict=True)

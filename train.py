            ...
            if i % 100 == 0:
                with torch.no_grad():
                    ...
                    try:
                        utils.save_image(
                            sample,
                            f"/content/drive/My Drive/Colab Notebooks/I2I_StyleGAN2/{str(i).zfill(6)}.png", # sample
            ...
            if i % 1000 == 0:
                try:
                    torch.save(
                        ...
                        f"/content/drive/My Drive/Colab Notebooks/I2I_StyleGAN2/{str(i).zfill(6)}.pt", # checkpoint/xxx
                      )
                except Exception as e:
